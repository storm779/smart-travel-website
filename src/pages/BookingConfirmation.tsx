...
export default function BookingConfirmation() {
  ...
  if (!booking) {
    return (
      <div className="min-h-screen bg-gray-50 pt-28 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold font-kugile text-gray-900 mb-4">Booking not found</h2>
          <Link
            to="/"
        ...
        <Reveal>
          <div className="bg-white rounded-[2.5rem] shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold font-kugile text-gray-900 mb-2">
                Booking Confirmed!
              </h1>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold font-kugile text-gray-900 mb-2">
                      {packageData.title}
                    </h3>
            ...
            <div className="mb-6">
              <h2 className="text-xl font-bold font-kugile text-gray-900 mb-4">Travel Details</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 flex items-center justify-center space-x-2 bg-gray-900 hover:bg-gray-800 text-white font-semibold py-3 rounded-xl transition">
                <Download className="h-5 w-5" />
                <span>Download/Print</span>
              </button>
              <Link
                to="/my-bookings"
                className="flex-1 flex items-center justify-center space-x-2 bg-lilac-600 hover:bg-lilac-700 text-white font-semibold py-3 rounded-xl transition">
                <span>View All Bookings</span>
              </Link>
            </div>

            <div className="mt-8 p-4 bg-gray-50 rounded-xl">
              <h3 className="font-semibold font-kugile text-gray-900 mb-2">Need Help?</h3>
