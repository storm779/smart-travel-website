...
import { Calendar, MapPin, Users, Package, CreditCard, CheckCircle, Clock, XCircle } from 'lucide-react';
        ...
        {bookings.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-600 px-6 py-3 rounded-lg font-semibold transition"
              >
                Try Smart Planner
              </button>
            </div>
          ...
          <div className="space-y-6">
            {bookings.map((booking) => {
              const title = booking.booking_type === 'package'
                ? booking.packages?.title
                : booking.itinerary_data?.itinerary?.title || 'Custom Itinerary';

              const destination = booking.booking_type === 'package'
                ? booking.packages?.destination
                : booking.itinerary_data?.preferences?.destination || booking.pickup_city;

              const image = booking.booking_type === 'package'
                ? booking.packages?.images?.[0]
                : booking.itinerary_data?.itinerary?.images?.[0] || 'https://images.pexels.com/photos/1285625/pexels-photo-1285625.jpeg';
                    ...
                    <div className="md:w-2/3 p-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div>
                          ...
                          <p className="text-sm font-semibold text-gray-900">{booking.booking_reference}</p>
                        </div>
                        <div>
                      ...
                      <div className="border-t pt-4 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <p className="font-medium text-gray-900 capitalize">{booking.payment_status}</p>
                          </div>
                        </div>
                      </div>
